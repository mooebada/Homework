...
// ! Function under test
function sanitizeFruitBasket(unSanitizedArray, unSanitizedItem) {
  const sanitizedArray = unSanitizedArray.filter(
    (item) => item !== unSanitizedItem
  );
...
describe('sanitizeFruitBasket', () => {
  ...
  test('should not modify the original `fruitBasket` array', () => {
    ...
    const result = originalFruitBasketContents;
